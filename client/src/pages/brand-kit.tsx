...
import type { GuestBrandKit } from "@/types/carousel";
...
function BrandKitCard({ kit, onSave, onDelete }: { kit: GuestBrandKit; onSave: (id: string, data: Partial<GuestBrandKit>) => void; onDelete: (id: string) => void }) {
